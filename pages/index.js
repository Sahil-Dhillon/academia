  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <form className="lg:w-1/2 md:w-1/2 mx-auto">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full">
          <div className="relative">
          <input required minLength={8} placeholder="password" type="password" id="password" name="password" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
